 ...
 */
class Tim_IncreasePrice_Block_Adminhtml_Quote_Edit_Tab_Actions
    extends Mage_Adminhtml_Block_Promo_Quote_Edit_Tab_Actions
{
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('is_increase', 'select', array(
            'name'      => 'is_increase',
            'label'     => Mage::helper('salesrule')->__('Increase Amount'),
            'title'     => Mage::helper('salesrule')->__('Increase Amount'),
            'values'    => array(
